        ...
        if (regex_search(m_message, http_matches, http_pattern, regex_constants::match_default)) {
            ...
            if (http_method != "GET") {
                ...
                ss << http_ver << " "
                   ...
                   << "Server: " << frkminer_get_buildinfo()->project_name_with_version << "\r\n"
...
Json::Value ApiConnection::getMinerStat1() {
    ...
    jRes[0] = frkminer_get_buildinfo()->project_name_with_version; // miner version.
...
Json::Value ApiConnection::getMinerStatDetail() {
    ...
    /* Host Info */
    Json::Value hostinfo;
    hostinfo["version"] = frkminer_get_buildinfo()->project_name_with_version; // miner version.
